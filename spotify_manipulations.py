...
def spotify_manipulations_2():
    ...
    print("")
    print("Creating Spotify Visualizations #1 and #2.")
    print("Please exit the plot to see Visualization #2.")
    print("Once done viewing Visualization #2, please exit to continue the program.")
    print("")
