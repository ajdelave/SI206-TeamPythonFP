...
def visualization_2():
    ...
    info2.columns = ['Track Number', 'Average Popularity of Your Top Songs']
    ...
    sns.regplot(x='Track Number', y='Average Popularity of Your Top Songs', data=info2, color='black', line_kws={"color":"black","alpha":0.7,"lw":5})
    plt.show()
